...
public class ReportFrame extends JFrame{
    ...
    private JLabel jlbTitle=new JLabel("Select Type Of Report");
    ...
    private JButton jbtDaily = new JButton("Daily Sales Details Report");
    private JButton jbtAnnual = new JButton("Monthly Staff Sales Report");
    private JButton jbtTop5 = new JButton("Top 5 Routes Report");
    private JButton jbtMonthlySales = new JButton("Monthly Sales Summary Report");
...
public ReportFrame(String position,String staffID){
    setIcon();
    thisFrame=this;
    ...
    jpCenterCenter.add(jbtDaily);
    jpCenterCenter.add(jbtAnnual);
    jpCenterCenter.add(jbtMonthlySales);
    jpCenterCenter.add(jbtTop5);
    ...
    jbtSchedule.addActionListener(new ScheduleListener());
     ...
     jbtHome.addActionListener(new HomeListener());
       ...
       jbtDaily.addActionListener(new WeekListener());
       jbtAnnual.addActionListener(new AnnualListener());
       jbtTop5.addActionListener(new TopListener());
       jbtMonthlySales.addActionListener(new MonthlyListener());
        ...
        jbtTop5.setFont(smallFont);
        jbtDaily.setFont(smallFont);
        jbtMonthlySales.setFont(smallFont);
        jbtAnnual.setFont(smallFont);
...
private class WeekListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {                        
              new DailySalesFrame(position,staffID);
                thisFrame.dispose();
             }}
private class AnnualListener implements ActionListener {
        ...
        @Override
        public void actionPerformed(ActionEvent e) {                        
              new MonthlyStaffFrame(position,staffID);
                thisFrame.dispose();
             }}
private class TopListener implements ActionListener {
        ...
        @Override
        public void actionPerformed(ActionEvent e) {                        
      //        new Top5Frame1(position,staffID);
                thisFrame.dispose();
             }}
private class MonthlyListener implements ActionListener {

        @Override
        public void actionPerformed(ActionEvent e) {                        
              new MonthlySaleFrame1(position,staffID);
                thisFrame.dispose();
             }}
