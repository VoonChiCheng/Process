...
public class ExchangeSchedule extends JFrame{
...
//      private JTextField jtfInput = new JTextField(" ");
  //    private JButton jbtConfirm = new JButton("Confirm");
    ...
    public ExchangeSchedule(ETicket ET,String BusType,String StaffID,String Position){
        setIcon();
   ...
   /*     String[] columnNames = {"Schedule ID",
       ...
       tableModel = new CustomTable();    
        tableModel.retrieveExchangeTicket(et.getDestination(), busType,et.getScheduleID());
