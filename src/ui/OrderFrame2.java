...
private ArrayList<Route> routeList = new ArrayList<Route>();
  ...
  //    private JLabel jlbInput = new JLabel("Schedule ID : ");
   ...
   private DefaultComboBoxModel jcb= new DefaultComboBoxModel();
    ...
    public OrderFrame2(String destination,String date,int Valid,String SaleID,String StaffID,String Position,ArrayList<VSchedule> VS) throws ParseException{
        setIcon();
       ...
       datePick.setFormats(dateFormat);
        ...
        jpCenter.add(jlbDestination);
          jcboRouteList.setSelectedItem(destination);
   ...
   /*     String[] columnNames = {"Schedule ID",
    ...
    //    Object[][] data = {};
        ...
        tableModel.retreiveRecordsByBoth(destination, date);
...
//                new OrderFrame1(selectedDestinationStr,valid, saleID,staffID,position,vs);
      ...
      addWindowListener(new WindowListener());
        ...
        //     new OrderFrame2("Kuala Lumpur","2016-03-15");
        } catch (Exception ex) { 
            ex.printStackTrace(); 
        }
