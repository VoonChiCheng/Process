...
public class SeatSelectionE extends JFrame{
...
//private OrderDA orderDA;
   ...
   private JTextField jtfTime = new JTextField();
    ...
    private JPanel jpLeftRightBtm = new JPanel(new GridLayout(5,4));
...
//   private JTextField jtfOrderNo = new JTextField("");
  private JLabel jlbTitle2 = new JLabel("Selected Order");
   ...
   //   public Sale sale = null;
    ...
    public SeatSelectionE(Schedule Schedule,int Valid,String SaleID,String StaffID,String Position,ArrayList<VSchedule> VS){
        setIcon();
