...
public class MonthlyStaffFrame extends JFrame{
   // private AnnualStaffFrame thisFrame;
    ...
    private JLabel jlbTitle=new JLabel("Monthly Staff Sales Summary Report");
...
public MonthlyStaffFrame(String position,String staffID){
    setIcon();
   // thisFrame=this;
    ...
    jbtSchedule.addActionListener(new ScheduleListener());
     ...
     jbtHome.addActionListener(new HomeListener());
        setTitle("Generate Monthly Staff Sales Summary Report");        
...
private class GenerateListener implements ActionListener{
    public void actionPerformed(ActionEvent e)
    {
       ...
       String reportSource= "D:\\FYP\\FYP\\src\\reportTemplates\\MonthlyStaff.jrxml";
       Map<String,Object> params=new HashMap<String,Object>();
       
      params.put("StartMonth", date1);
       params.put("EndMonth", date2);
       try{
