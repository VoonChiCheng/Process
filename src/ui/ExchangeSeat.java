...
public class ExchangeSeat extends JFrame{
 ...
 //   CheckboxGroup cbg;
  ...
  //ou  private JButton jbtRoute = new JButton("Route");
  ...
  //  private JPanel jpRightBtm = new JPanel(new FlowLayout());
   ...
   private JTextField jtfOrderNo = new JTextField("");
    ...
    public ExchangeSeat(Schedule Schedule,ETicket ET,String BusType,String StaffID,String Position){
        setIcon();
                  ...
                  if(jcb3.isSelected()){
                   ...
                   //   orderControl.updateTicket(ticket,19);
                                  //     array1[19] = 1;
                                    ...
                                    if(jcb21.isSelected()){
                                        exchangeControl.updateExchangeTicketOld(et.getTicketID());
                      exchangeControl.updateExchangeTicketNew(et.getSaleID(), ticket.get(20).getTicketID());
                       ticketID = ticket.get(20).getTicketID();
                     // orderControl.updateTicket(ticket,20);
                                    //    array1[20] = 1;
                  }
                                     if(jcb22.isSelected()){
                                         exchangeControl.updateExchangeTicketOld(et.getTicketID());
                      exchangeControl.updateExchangeTicketNew(et.getSaleID(), ticket.get(21).getTicketID());
                       ticketID = ticket.get(21).getTicketID();
                    //  orderControl.updateTicket(ticket,21);
                                     //    array1[21] = 1;
                  }
                                      if(jcb23.isSelected()){
                                          exchangeControl.updateExchangeTicketOld(et.getTicketID());
                      exchangeControl.updateExchangeTicketNew(et.getSaleID(), ticket.get(22).getTicketID());
                       ticketID = ticket.get(22).getTicketID();
                    //  orderControl.updateTicket(ticket,22);
                                   //       array1[22] = 1;
                  }
                                       if(jcb24.isSelected()){
                                           exchangeControl.updateExchangeTicketOld(et.getTicketID());
                      exchangeControl.updateExchangeTicketNew(et.getSaleID(), ticket.get(23).getTicketID());
                       ticketID = ticket.get(23).getTicketID();
                     // orderControl.updateTicket(ticket,23);
                                    //       array1[23] = 1;
                  }
                                        if(jcb25.isSelected()){
                                            exchangeControl.updateExchangeTicketOld(et.getTicketID());
                      exchangeControl.updateExchangeTicketNew(et.getSaleID(), ticket.get(24).getTicketID());
                       ticketID = ticket.get(24).getTicketID();
                    //  orderControl.updateTicket(ticket,24);
                                       //     array1[24] = 1;
                  }
                                         if(jcb26.isSelected()){
                                             exchangeControl.updateExchangeTicketOld(et.getTicketID());
                      exchangeControl.updateExchangeTicketNew(et.getSaleID(), ticket.get(25).getTicketID());
                       ticketID = ticket.get(25).getTicketID();
                    //  orderControl.updateTicket(ticket,25);
                                          //   array1[25] = 1;
                  }
                                          if(jcb27.isSelected()){
                                              exchangeControl.updateExchangeTicketOld(et.getTicketID());
                      exchangeControl.updateExchangeTicketNew(et.getSaleID(), ticket.get(26).getTicketID());
                       ticketID = ticket.get(26).getTicketID();
                    //  orderControl.updateTicket(ticket,26);
                                       //       array1[26] = 1;
                  }
                                           if(jcb28.isSelected()){
                                               exchangeControl.updateExchangeTicketOld(et.getTicketID());
                      exchangeControl.updateExchangeTicketNew(et.getSaleID(), ticket.get(27).getTicketID());
                       ticketID = ticket.get(27).getTicketID();
                   //   orderControl.updateTicket(ticket,27);
                                        //       array1[27] = 1;
                  }
                                            if(jcb29.isSelected()){
                                                exchangeControl.updateExchangeTicketOld(et.getTicketID());
                      exchangeControl.updateExchangeTicketNew(et.getSaleID(), ticket.get(28).getTicketID());
                       ticketID = ticket.get(28).getTicketID();
                    //  orderControl.updateTicket(ticket,28);
                                           //     array1[28] = 1;
                  }
                                             if(jcb30.isSelected()){
                                                 exchangeControl.updateExchangeTicketOld(et.getTicketID());
                      exchangeControl.updateExchangeTicketNew(et.getSaleID(), ticket.get(29).getTicketID());
                       ticketID = ticket.get(29).getTicketID();
                  //    orderControl.updateTicket(ticket,29);
                                            //     array1[29] = 1;
                  }
                                              if(jcb31.isSelected()){
                                                  exchangeControl.updateExchangeTicketOld(et.getTicketID());
                      exchangeControl.updateExchangeTicketNew(et.getSaleID(), ticket.get(30).getTicketID());
                       ticketID = ticket.get(30).getTicketID();
                   //   orderControl.updateTicket(ticket,30);
                                             //     array1[30] = 1;
                  }
                                               if(jcb32.isSelected()){
                                                   exchangeControl.updateExchangeTicketOld(et.getTicketID());
                      exchangeControl.updateExchangeTicketNew(et.getSaleID(), ticket.get(31).getTicketID());
                     ticketID = ticket.get(31).getTicketID();
