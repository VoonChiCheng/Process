...
public class MaintainRoute extends JFrame{
//     private AddRouteFrame addframe=null;
 private UpdateRouteFrame updateframe=null;
    ...
    private JLabel jlbTitle=new JLabel("Maintain Route");
    ...
    private RouteTableModel routeTable;
...
//   private MaintainBusSchedule scheduleFrame=null;
   private MaintainRoute thisFrame;
...
//   private HomepageFrame homeFrame=null;
   ...
   public MaintainRoute(){
     
 }
 
 
public MaintainRoute(String position,String staffID){
       thisFrame=this;
 ...
 addWindowListener(new WindowListener());
    routeTable=new RouteTableModel();
    tablemodel=new JTable(routeTable);
    sorter = new TableRowSorter(routeTable);
   ...
   tablemodel.setPreferredScrollableViewportSize(new Dimension(600, 150));
    ...
    add(jpSouth,BorderLayout.SOUTH);
        ...
        jbtRoute.setBackground(new Color(204, 255, 255));
...
private class UpdateListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if(e.getSource()==jbtUpdate){
                if(updateframe==null)
                    updateframe=new UpdateRouteFrame( position,staffID);
...
//                if(addframe==null)
//                    addframe=new AddRouteFrame(position,staffID);
