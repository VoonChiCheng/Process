...
public class OrderFrame1 extends JFrame{
...
private ArrayList<Route> routeList = new ArrayList<Route>();
   ...
   private DefaultComboBoxModel jcb= new DefaultComboBoxModel();
    ...
    public OrderFrame1(String destination,int Valid,String SaleID,String StaffID,String Position,ArrayList<VSchedule> VS){
        setIcon();
   ...
   /*     String[] columnNames = {"Schedule ID",
    ...
    //    Object[][] data = {};
        ...
        tableModel.retrieveRecordsByDestination(destination);
