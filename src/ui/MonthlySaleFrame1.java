...
public class MonthlySaleFrame1 extends JFrame{
//    private MonthlySalesFrame thisFrame;
    ...
    private JLabel jlbTitle=new JLabel("Monthly Sales Summary Report");
 ...
 JPanel jpCenterSouth=new JPanel();
  private String position;
   ...
   /*public MonthlySalesFrame(){
     
 }*/
 
public MonthlySaleFrame1(String position,String staffID){
//    thisFrame=this;
    setIcon();
    ...
    jbtSchedule.addActionListener(new ScheduleListener());
     ...
     jbtHome.addActionListener(new HomeListener());
        ...
        setTitle("Generate Monthly Sales Summary Report");        
...
private class GenerateListener implements ActionListener{
    public void actionPerformed(ActionEvent e)
    {
     ...
     //  chooser.setCurrentDirectory(new java.io.File("."));
      ...
      String reportSource ="D:\\FYP\\FYP\\src\\reportTemplates\\MonthlySales.jrxml";
     //String reportSource = "D:\\reportTemplates\\MonthlySales.jrxml";
     //InputStream is = this.getClass().getClassLoader().getResourceAsStream("MontlySales.jrxml");
  // String  reportSource = String.format("%s", is);
       Map<String,Object> params=new HashMap<String,Object>();
       
      // String date1 = dateFormat.format(date11);
      // String date2 = dateFormat.format(date22);
      ...
      params.put("Start", date1);
       ...
       try{
          ...
          //   showErrorDialog(jrex.toString());

          // JOptionPane.showMessageDialog(null,jrex.printStackTrace());
...
public static void main(String[] args) {
     try { 
       ...
       new MonthlySaleFrame1("Manager","S002");
    }
